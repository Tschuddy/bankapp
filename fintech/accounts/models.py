...
class OTPCODE(models.Model):
    ...
    delivery_method = models.CharField(max_length=10, choices=OTP_DELIVERY_METHODS, default='email')
    expires_at = models.DateTimeField(default=default_expiry)  # Use function instead of lambda
